...
export const PROJECTS = [
  {
    ...
    year: '2025',
    location: 'Lualaba',
    image: '/images/projects/orphelinat-lualaba.webp',
    highlights: [
  ...
  },
  {
    ...
    year: '2024',
    location: 'Uvira',
    image: '/images/projects/education-uvira.webp',
    highlights: [
  ...
  },
  {
    ...
    year: '2024',
    location: 'Tshilenge',
    image: '/images/projects/perse-agriculture.webp',
    highlights: [
  ...
  },
  {
    ...
    year: '2019',
    location: 'Kinshasa',
    image: '/images/projects/ecole-mwinda.webp',
    highlights: [
  ...
  },
  {
    ...
    year: '2019',
    location: 'Lubumbashi',
    image: '/images/projects/pharmacie-lubumbashi.webp',
    highlights: [
...
export const BLOG_POSTS = [
  {
    ...
    date: '2024-02-05',
    image: '/images/blog/tout-savoir-fom.webp',
    body: [
  ...
  },
  {
    ...
    date: '2021-10-26',
    image: '/images/blog/acquisition-hectares-mbuji.webp',
    body: [
  ...
  },
  {
    ...
    date: '2019-12-20',
    image: '/images/blog/inauguration-ecole.webp',
    body: [
  ...
  },
  {
    ...
    date: '2019-12-28',
    image: '/images/blog/inauguration-pharmacie.webp',
    body: [
  ...
  },
  {
    ...
    date: '2019-12-23',
    image: '/images/blog/partenariat-kintambo.webp',
    body: [
  ...
  },
  {
    ...
    date: '2021-07-01',
    image: '/images/blog/je-suis-goma.webp',
    body: [
...
export const EVENTS = [
  ...
  // ===== PASSES (du plus recent au plus ancien) =====
  {
    id: 'expo-mamu-noel-2025',
    status: 'past',
    title: 'Exposition Mamu Noel',
    date: '18 Decembre 2025',
    location: 'Kinshasa, RDC 🇨🇩',
    description: 'La Fondation Mwinda celebre la saison de Noel a travers une exposition artistique mettant en valeur les artistes congolais et la solidarite communautaire.',
    flyer: "/images/event/exposition-mamu-noel-18-decembre-2025.webp",
  },
  {
    id: 'perf-artistique-italie-2025',
    status: 'past',
    title: 'Performance Artistique - Italie',
    date: '19 Septembre 2025',
    location: 'Italie 🇮🇹',
    description: "Performance artistique et exposition de toiles et sculptures africaines organisee en Italie, portant le message de la paix et la richesse culturelle congolaise.",
    flyer: "/images/event/performance-artistique-et-exposition-des-toiles-et-des-sculptures-africains-19-septembre-2025-italie.webp",
  },
  {
    id: 'expo-matshozi-2025',
    status: 'past',
    title: "Exposition Matshozi Yangu - L'art congolais pour la paix",
    date: '15 Fevrier 2025',
    location: 'Kinshasa, RDC 🇨🇩',
    description: "Exposition artistique en soutien a la paix a l'Est du Congo. Les oeuvres des artistes congolais expriment la souffrance et l'espoir des populations touchees par les conflits.",
    flyer: "/images/event/exposition-matshozi-yangu-l-art-congolais-pour-la-paix-a-l-est-15-fevrier-2025.webp",
  },
  {
    id: 'ag-2024',
    status: 'past',
    title: 'Assemblee Generale 2024',
    date: '27 Octobre 2024',
    location: 'Bruxelles, Belgique 🇧🇪',
    description: "L'assemblee generale annuelle de la Fondation Mwinda reunit administrateurs, membres et partenaires pour faire le bilan de l'annee et tracer les perspectives pour 2025.",
    flyer: "/images/event/assemblee-generale-2024-27-octobre-2024.webp",
  },
  {
    id: 'atelier-arts-orphelinat-2024',
    status: 'past',
    title: "Atelier Arts Plastiques a l'Orphelinat La Samaritaine",
    date: '13 Juillet 2024',
    location: 'Kinshasa, RDC 🇨🇩',
    description: "Atelier de creation artistique organise pour les enfants de l'orphelinat La Samaritaine. L'art comme vecteur d'expression et d'epanouissement pour les enfants vulnerables.",
    flyer: "/images/event/atelier-arts-plastiques-a-l-orphelinat-la-samaritaine-13-juillet-2024.webp",
  },
  {
    id: 'spaghetti-fundraiser-2024',
    status: 'past',
    title: 'Spaghetti Dinner Fundraiser',
    date: '6 Juillet 2024',
    location: 'Bruxelles, Belgique 🇧🇪',
    description: 'Soiree caritative organisee par la diaspora congolaise en Belgique pour soutenir les projets humanitaires de la Fondation Mwinda en RDC.',
    flyer: "/images/event/spaghetti-dinner-fundraiser-6-juillet-2024.webp",
  },
  {
    id: 'autism-awareness-2024',
    status: 'past',
    title: 'Autism Awareness',
    date: '21 Avril 2024',
    location: 'Bruxelles, Belgique 🇧🇪',
    description: "Evenement de sensibilisation a l'autisme pour promouvoir l'inclusion et la comprehension des personnes autistes au sein de la communaute congolaise.",
    flyer: "/images/event/autism-awareness-21-avril-2024.webp",
  },
  {
    id: 'ag-2023',
    status: 'past',
    title: 'Assemblee Generale 2023',
    date: '5 Novembre 2023',
    location: 'Bruxelles, Belgique 🇧🇪',
    description: "L'assemblee generale 2023 dresse le bilan des activites de l'annee et definit les orientations strategiques pour renforcer l'impact humanitaire en RDC.",
    flyer: "/images/event/assemblee-generale-2023-5-novembre-2023.webp",
  },
  {
    id: 'formation-entrepreneuriat-2023',
    status: 'past',
    title: 'Formation et Ateliers en Entrepreneuriat',
    date: '30 Septembre 2023',
    location: 'Kinshasa, RDC 🇨🇩',
    description: "Formation destinee a la jeunesse congolaise pour developper des competences entrepreneuriales et soutenir leur rehabilitation sociale et economique.",
    flyer: "/images/event/formation-et-ateliers-en-entrepreneuriat-la-jeunesse-congolaise-vers-le-programme-de-la-rehabilitation-30-septembre-2023.webp",
  },
  {
    id: 'conf-jeunes-2023',
    status: 'past',
    title: 'Conference - Role des Enfants et des Jeunes',
    date: '15 Juillet 2023',
    location: 'Kinshasa, RDC 🇨🇩',
    description: "Conference sur le role des enfants et des jeunes dans la promotion d'un developpement durable, reunissant jeunes leaders, educateurs et acteurs de la societe civile.",
    flyer: "/images/event/conference-role-des-enfants-et-jeunes-dans-la-promotion-d-un-developpement-durable-15-juillet-2023.webp",
  },
  {
    id: 'atelier-contes-2023',
    status: 'past',
    title: "Atelier de Contes et d'Illustrations",
    date: '18 Fevrier 2023',
    location: 'Kinshasa, RDC 🇨🇩',
    description: "Atelier creatif dedie aux contes africains et aux illustrations artistiques, offrant aux enfants un espace d'expression et de decouverte de la richesse culturelle congolaise.",
    flyer: "/images/event/atelier-de-contes-et-d-illustrations-18-fevrier-2023.webp",
  },
  {
    id: 'fundraiser-spaghetti-2022',
    status: 'past',
    title: 'Fundraiser Spaghetti et Dinner',
    date: '10 Septembre 2022',
    location: 'Bruxelles, Belgique 🇧🇪',
    description: "Soiree de collecte de fonds organisee par la diaspora congolaise pour financer les projets humanitaires de la Fondation Mwinda. Un moment de convivialite au service d'une noble cause.",
    flyer: "/images/event/fundraiser-spaghetti-et-dinner-10-septembre-2022.webp",
  },
  {
    id: 'tournoi-foot-2022',
    status: 'past',
    title: 'Tournoi de Football Junior',
    date: '30 Juillet 2022',
    location: 'Kinshasa, RDC 🇨🇩',
    description: "Tournoi de football organise pour les jeunes, promouvant le sport, la sante et les valeurs de fair-play. Un evenement festif et federateur pour la jeunesse congolaise.",
    flyer: "/images/event/tournoi-de-football-junior-30-juillet-2022.webp",
  },
  {
    id: 'conf-handicap-2022',
    status: 'past',
    title: 'Conference - Le Regard du Handicap dans notre Communaute',
    date: '26 Juin 2022',
    location: 'Kinshasa, RDC 🇨🇩',
    description: "Conference en direct sur les defis et la perception du handicap dans la communaute congolaise, sensibilisant a l'inclusion et aux droits des personnes handicapees.",
    flyer: "/images/event/conference-de-bas-live-sur-le-regard-du-handicap-dans-notre-communaute-26-juin-2022.webp",
  },
  {
    id: 'diversite-culturelle-2022',
    status: 'past',
    title: 'Journee Mondiale pour la Diversite Culturelle',
    date: '21 Mai 2022',
    location: 'Kinshasa, RDC 🇨🇩',
    description: "A l'occasion de la Journee Mondiale pour la Diversite Culturelle, la Fondation Mwinda celebre la richesse des cultures congolaises et promeut le dialogue interculturel.",
    flyer: "/images/event/journee-mondiale-pour-la-diversite-culturelle-21-mai-2022.webp",
  },
  {
    id: 'tends-moi-la-main-2022',
    status: 'past',
    title: 'Lancement du Projet Tends-moi la Main',
    date: '5 Mars 2022',
    location: 'Kinshasa, RDC 🇨🇩',
    description: "Lancement officiel du projet humanitaire Tends-moi la Main, visant a soutenir les personnes vulnerables et a renforcer la solidarite au sein des communautes congolaises.",
    flyer: "/images/event/lancement-officiel-du-projet-tends-moi-la-main-5-mars-2022.webp",
  },
  {
    id: 'fom-kassai-2022',
    status: 'past',
    title: 'FOM Kassai Central - Reception des Demunis',
    date: '28 Fevrier 2022',
    location: 'Kasai-Central, RDC 🇨🇩',
    description: "La section Kassai Central de la Fondation Mwinda organise une reception pour les personnes demunies, offrant aide materielle et soutien moral aux plus vulnerables.",
    flyer: "/images/event/la-fom-kassai-central-en-reception-des-demunis-28-fevrier-2022.webp",
  },
  {
    id: 'deplaces-guerre-2022',
    status: 'past',
    title: 'Echange avec les Deplaces de Guerre de Caen Kanunga',
    date: '12 Fevrier 2022',
    location: 'Kinshasa, RDC 🇨🇩',
    description: "Rencontre et echange avec les personnes deplacees du conflit de Caen Kanunga, leur apportant soutien, ecoute et aide humanitaire dans cette periode difficile.",
    flyer: "/images/event/echange-avec-les-deplaces-de-guerre-de-caen-kanunga-12-fevrier-2022.webp",
  },
  {
    id: 'mendicite-conf-2022',
    status: 'past',
    title: 'Conference - Remedier au Phenomene de la Mendicite',
    date: '4 Janvier 2022',
    location: 'Kinshasa, RDC 🇨🇩',
    description: "Conference de reflexion sur les causes profondes de la mendicite en RDC et les pistes d'action concretes pour y remedier, reunissant acteurs sociaux et decideurs.",
    flyer: "/images/event/conferences-quelles-sont-les-pistes-pour-remedier-au-phenomene-de-la-mendicite-4-janvier-2022.webp",
  },
  {
    id: 'noel-2021',
    status: 'past',
    title: "Celebration Noel - Allumons les Etoiles des Enfants",
    date: '25 Decembre 2021',
    location: 'Kinshasa, RDC 🇨🇩',
    description: "La Fondation Mwinda celebre Noel avec les enfants les plus vulnerables, allumant les etoiles de leur bonheur et leur offrant joie, cadeaux et moments de partage.",
    flyer: "/images/event/celebration-noel-allumons-les-etoiles-des-enfants-25-decembre-2021.webp",
  },
  {
    id: 'expo-art-2021',
    status: 'past',
    title: "Exposition des Oeuvres d'Art",
    date: '16 Juillet 2021',
    location: 'Kinshasa, RDC 🇨🇩',
    description: "Exposition artistique mettant en valeur les oeuvres d'artistes congolais talentueux, celebrant la creativite locale et soutenant les artistes emergents de la RDC.",
    flyer: "/images/event/exposition-des-uvres-d-art-16-juillet-2021.webp",
  },
  {
    id: 'competences-jeunes-2021',
    status: 'past',
    title: "Journee Internationale des Competences des Jeunes",
    date: '15 Juillet 2021',
    location: 'Kinshasa, RDC 🇨🇩',
    description: "A l'occasion de cette journee, la FOM organise des ateliers pratiques pour outiller la jeunesse congolaise et favoriser son insertion professionnelle.",
    flyer: "/images/event/journee-internationale-des-competences-des-jeunes-15-juillet-2021.webp",
  },
  {
    id: 'conference-culture-2021',
    status: 'past',
    title: 'Conference - Comment vendre la culture congolaise',
    date: '15 Juillet 2021',
    location: 'Kinshasa, RDC 🇨🇩',
    ...
    flyer: "/images/event/conference-comment-vendre-la-culture-congolaise-le-15-juillet-2021.webp",
  },
  {
  ...
  },
  {
    ...
    date: '21 Avril 2021',
    location: 'Kinshasa, RDC 🇨🇩',
    description: "La Fondation Mwinda a marque cette journee par des actions de sensibilisation et de distribution de moustiquaires dans les quartiers vulnerables de Kinshasa.",
    flyer: "/images/event/conference-de-lutte-contre-le-paludisme-21-avril-2021.webp",
  },
  {
    id: 'peinture-college-2021',
    status: 'past',
    title: "Mise en Peinture du College Mwinda",
    date: '16 Avril 2021',
    location: 'Kinshasa, RDC 🇨🇩',
    description: "Journee de travaux communautaires pour la mise en peinture du College Mwinda, embellissant le cadre de vie scolaire et renforçant la fierte de la communaute.",
    flyer: "/images/event/la-mise-de-peinture-au-college-mwinda-16-avril-2021.webp",
  },
  {
    id: 'marche-sante-2021',
    status: 'past',
    title: "Marche de Sante - Leadership Feminin",
    date: '13 Mars 2021',
    location: 'Kinshasa, RDC 🇨🇩',
    description: "Marche de sante celebrant le leadership feminin et l'egalite dans le monde, rassemblant la communaute autour des valeurs de solidarite et de promotion de la sante.",
    flyer: "/images/event/marche-de-sante-leadership-feminin-egalite-dans-le-monde-13-mars-2021.webp",
  },
  {
    ...
    flyer: "/images/event/journee-internationale-de-la-femme-8-mars-2021.webp",
  },
  {
    id: 'wedding-planner-2021',
    status: 'past',
    title: "Formation Wedding Planner et Designer",
    date: '8 Fevrier 2021',
    location: 'Kinshasa, RDC 🇨🇩',
    description: "Formation professionnelle en organisation de mariages et design, offrant aux femmes et aux jeunes des competences pratiques pour developper une activite entrepreneuriale.",
    flyer: "/images/event/formation-wedding-planner-et-designer-8-fevrier-2021.webp",
  },
  {
    id: 'remise-hygiene-2021',
    status: 'past',
    title: "Remise d'Articles Hygieniques a la Prison de Camp Molayi",
    date: '2 Janvier 2021',
    location: 'Kinshasa, RDC 🇨🇩',
    description: "Distribution d'articles hygieniques aux detenus de la prison centrale de Camp Molayi, un geste de solidarite pour preserver la dignite humaine meme en milieu carceral.",
    flyer: "/images/event/remise-des-articles-hygieniques-a-la-prison-centrale-de-camp-molayi-02-janvier-2021.webp",
  },
  {
    id: 'noel-orphelins-2020',
    status: 'past',
    title: "Noel au Coeur des Cris des Orphelins",
    date: '25 Decembre 2020',
    location: 'Kinshasa, RDC 🇨🇩',
    description: "La Fondation Mwinda offre un Noel chaleureux aux orphelins, apportant joie et espoir aux enfants qui en ont le plus besoin en cette periode de fetes.",
    flyer: "/images/event/noel-au-cur-des-cris-des-orphelins-25-decembre-2020.webp",
  },
  {
    ...
    flyer: "/images/event/la-fom-celebre-son-premier-anniversaire-aupres-des-personnes-vulnerables-le-17-octobre-2020.webp",
  },
  {
    id: 'journee-vieillards-2020',
    status: 'past',
    title: "Journee des Vieillards",
    date: '1 Octobre 2020',
    location: 'Kinshasa, RDC 🇨🇩',
    description: "La FOM honore les personnes agees lors de la Journee Internationale des Personnes Agees, leur rendant visite et leur apportant aide, affection et consideration.",
    flyer: "/images/event/journee-des-vieillards-1-octobre-2020.webp",
  },
  {
    id: 'peinture-hospices-2020',
    status: 'past',
    title: "Peinture des Hospices des Vieillards de Kintambo",
    date: '22 Juillet 2020',
    location: 'Kintambo, Kinshasa 🇨🇩',
    description: "Journee de travaux benevoles pour la peinture des hospices des hommes ages de Kintambo, ameliorant leurs conditions d'hebergement et leur apportant chaleur et dignite.",
    flyer: "/images/event/peinturer-les-hospices-des-hommes-des-vieillards-de-quintambo-22-juillet-2020.webp",
  },
  {
    id: 'fournitures-orphelins-2020',
    status: 'past',
    title: "Remise de Fournitures Scolaires aux Orphelins",
    date: '18 Juillet 2020',
    location: 'Kinshasa, RDC 🇨🇩',
    description: "Distribution de fournitures scolaires aux enfants orphelins pour preparer la rentree scolaire, leur donnant les outils necessaires pour poursuivre leur education.",
    flyer: "/images/event/remise-des-fournitures-scolaires-aux-orphelins-18-juillet-2020.webp",
  },
  {
